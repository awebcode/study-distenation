...
const Footer = () => {
    return (
        <footer className="static bg-gray-900 text-white py-8 px-4 md:px-8 bottom-0">
            <div className="container  flex flex-col md:flex-row justify-between items-center w-full">
                <div className="mb-4 md:mb-0">
                    <div className=" flex items-center">
                        <Link href="/">
                            <Image height={1000} width={1000} className="h-auto w-auto" src="/assets/navbar/logo.svg" alt="Logo" />
                        </Link>
                    </div>
                ...
                <nav className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8 gap-6">
                    <div>
